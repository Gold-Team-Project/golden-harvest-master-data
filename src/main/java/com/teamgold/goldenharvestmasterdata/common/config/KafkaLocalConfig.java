package com.teamgold.goldenharvestmasterdata.common.config;
...
public class KafkaLocalConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "golden.harvest.master.data.processor");
        props.put("spring.json.use.type.headers", true);

        String typeMapping =
                "ItemMasterUpdatedEvent:com.teamgold.goldenharvestmasterdata.master.command.application.event.dto.ItemMasterUpdatedEvent, " +
                        "ItemOriginPriceUpdatedEvent:com.teamgold.goldenharvestmasterdata.master.command.application.event.dto.ItemOriginPriceUpdatedEvent";
